...
;; Homepage: https://github.com/VernonGrant/classic-theme.el
...
(custom-theme-set-faces
 ...
 '(xref-file-header ((t (:foreground "PaleGreen3"))))
 '(mode-line ((t (:background "cyan1" :foreground "darkslategrey"))))
 '(mode-line-inactive ((t (:background "DarkCyan" :foreground "AntiqueWhite"))))
 )
